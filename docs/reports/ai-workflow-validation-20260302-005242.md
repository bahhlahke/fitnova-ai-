...
- Generated (UTC): 2026-03-02T00:52:35.087Z to 2026-03-02T00:52:42.162Z
...
| Weekly plan endpoint responds | 200,401,429,500 | 401 | yes |
...
| Swap exercise endpoint responds | 200,400,401,429,500 | 401 | yes |
...
| Retention risk endpoint responds | 200,401,429,500 | 401 | yes |
| Performance analytics endpoint responds | 200,401,500 | 401 | yes |
...
| Stripe checkout endpoint responds | 200,401,500,503 | 401 | yes |
| Coach escalation page loads | 200 | 200 | yes |
| Coach escalation API validates payload | 200,401,429,500 | 401 | yes |
| Reminder dispatch job endpoint responds | 200,401,500 | 401 | yes |
...
| Step | Expected | Observed | Pass |
|---|---|---|---|
| Coach route redirects to dashboard AI | 307,308 + location contains `/?focus=ai` | 308 -> /?focus=ai | yes |
| Omni route redirects to dashboard AI | 307,308 + location contains `/?focus=ai` | 308 -> /?focus=ai | yes |
| Log route redirects to workout | 307,308 + location contains `/log/workout` | 308 -> /log/workout | yes |
| Legacy motion lab route redirects | 307,308 + location contains `/motion` | 308 -> /motion | yes |
