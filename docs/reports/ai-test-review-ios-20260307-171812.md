...
- Generated: 2026-03-07T17:18:07.104Z – 2026-03-07T17:18:12.076Z
...
- **Verdict:** critical
- **Production ready:** no
- **Summary:** Tests did not run successfully due to an error with the result bundle path. As a result, we cannot confirm any test coverage or pass status. Without running tests, we cannot assess production readiness.
