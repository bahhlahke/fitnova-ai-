...
const BY_NAME: Record<string, string> = {
  ...
  "foam roll": RAW_PEXELS.stretching_floor,
  "foam roll (thoracic spine)": RAW_PEXELS.stretching_floor,
  "foam roll thoracic spine": RAW_PEXELS.stretching_floor,
  "thoracic spine foam roll": RAW_PEXELS.stretching_floor,
  "band shoulder distraction": RAW_PEXELS.stretching_floor,
  "shoulder distraction": RAW_PEXELS.stretching_floor,
  "band distraction": RAW_PEXELS.stretching_floor,
  "hip flexor stretch": RAW_PEXELS.stretching_floor,
  "quad stretch": RAW_PEXELS.stretching_floor,
  "hamstring stretch": RAW_PEXELS.stretching_floor,
  "calf stretch": RAW_PEXELS.stretching_floor,
  "shoulder stretch": RAW_PEXELS.stretching_floor,
  "chest stretch": RAW_PEXELS.stretching_floor,
  "thoracic rotation": RAW_PEXELS.stretching_floor,
  "thoracic extension": RAW_PEXELS.stretching_floor,
  "spinal rotation": RAW_PEXELS.stretching_floor,
  "spinal twist": RAW_PEXELS.stretching_floor,
  ...
  "90/90": RAW_PEXELS.stretching_floor,
  "windmill": RAW_PEXELS.stretching_floor,
  "ankle circles": RAW_PEXELS.stretching_floor,
  "hip circles": RAW_PEXELS.stretching_floor,
  "arm circles": RAW_PEXELS.stretching_floor,
  "neck stretch": RAW_PEXELS.stretching_floor,
  "thread the needle": RAW_PEXELS.stretching_floor,
  "prayer stretch": RAW_PEXELS.stretching_floor,
  "doorframe stretch": RAW_PEXELS.stretching_floor,
